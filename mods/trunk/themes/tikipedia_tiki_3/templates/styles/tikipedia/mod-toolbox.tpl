...
{tr}toolbox{/tr}
{if $module_flip eq 'y'}
	<span id="moduleflip-{toolbox|cat:$module_position|cat:$module_ord|escape}">
		<a title="{tr}Toggle module contents{/tr}" class="flipmodtitle" href="javascript:icntoggle('mod-{toolbox|cat:$module_position|cat:$module_ord|escape}','module.png');"><img name="mod-{toolbox|cat:$module_position|cat:$module_ord|escape}icn" class="flipmodimage" src="pics/icons/module.png" border="0" width="16" height="16" alt="[{tr}toggle{/tr}]" /></a>
	</span>
{/if}
</h3>
{/if}
	<div id="mod-{toolbox|escape}" style="display: block" class="clearfix box-data">
		<div>{*  icons *}
{strip}
...
<!--//--><![CDATA[//><!--
				setsectionstate('mod-{toolbox|cat:$module_position|cat:$module_ord|escape}','{$module_dstate}', 'module.png');
//--><!]]>
			</script>
{/if}
	</div>
