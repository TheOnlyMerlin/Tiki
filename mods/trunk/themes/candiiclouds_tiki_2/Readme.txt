{* $Id$ *}
* __Name:__ Candii Clouds (candiiclouds.css)
* __Author and maintainer:__ Gary Cunningham-Lee (chibaguy)
* __License:__ GNU/GPL
* __Author URL:__ http://zukakakina.com
* __Description__: Candii Clouds theme by Mark Schulz (elpirtxis), licensed Creative Commons Attribution 2.5 and
adapted for TikiWiki CMS/Groupware by Gary Cunningham-Lee (chibaguy). Type 2-- Until IE7 supports display:table,
an HTML table is needed in tiki.tpl for graphic treatment and column integrity.
...
* styles/candiiclouds/horizright.png
* styles/candiiclouds/piink.gif
* styles/candiiclouds/s-stars.gif
* styles/candiiclouds/sbihead.gif
* styles/candiiclouds/star.gif
 
-=Documentation=-
http://themes.tikiwiki.org/Candii Clouds
