{* $Id$ *}
-=Theme details=-
* __Name:__ LiteJazz (litejazz.css)
...
* __Description__: Adaptation for TikiWiki CMS/Groupware of the GPL-licensed LiteJazz theme for Drupal by Roopletheme (http://roopletheme.com). Styling is provided for the topbar and bottombar custom code page sections, and there are three color variations, with the red and green versions importing litejazz.css as a CSS base.
