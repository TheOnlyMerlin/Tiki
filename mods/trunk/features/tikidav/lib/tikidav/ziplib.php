...
//REYES
	...
	function addRegularFile($filename, $content, $attrib = false) {
		...
		//echo $lheader;
		//echo $content;
		$this->zipcontent.=$lheader.$content;
	...
	function finish() {
		...
		//echo $this->dir;
		$this->zipcontent.=$this->dir;
		// Construct the "End of central directory record"
		//echo ZIP_ENDDIR_MAGIC;
		$this->zipcontent.=ZIP_ENDDIR_MAGIC;
		$this->zipcontent.= pack("vvvvVVv", 0, // Number of this disk.
