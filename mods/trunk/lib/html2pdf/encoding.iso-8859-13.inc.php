<?php
// $Header: /cvsroot/tikiwiki/_mods/lib/html2pdf/encoding.iso-8859-13.inc.php,v 1.1 2008-01-15 09:20:52 mose Exp $
...
"\xA1" => code_to_utf8(0x201D),	//	RIGHT DOUBLE QUOTATION MARK
"\xA2" => code_to_utf8(0x00A2),	//	CENT SIGN
"\xA3" => code_to_utf8(0x00A3),	//	POUND SIGN
"\xA4" => code_to_utf8(0x00A4),	//	CURRENCY SIGN
"\xA5" => code_to_utf8(0x201E),	//	DOUBLE LOW-9 QUOTATION MARK
"\xA6" => code_to_utf8(0x00A6),	//	BROKEN BAR
"\xA7" => code_to_utf8(0x00A7),	//	SECTION SIGN
"\xA8" => code_to_utf8(0x00D8),	//	LATIN CAPITAL LETTER O WITH STROKE
"\xA9" => code_to_utf8(0x00A9),	//	COPYRIGHT SIGN
"\xAA" => code_to_utf8(0x0156),	//	LATIN CAPITAL LETTER R WITH CEDILLA
...
"\xAF" => code_to_utf8(0x00C6),	//	LATIN CAPITAL LETTER AE
...
"\xB4" => code_to_utf8(0x201C),	//	LEFT DOUBLE QUOTATION MARK
"\xB5" => code_to_utf8(0x00B5),	//	MICRO SIGN
"\xB6" => code_to_utf8(0x00B6),	//	PILCROW SIGN
"\xB7" => code_to_utf8(0x00B7),	//	MIDDLE DOT
"\xB8" => code_to_utf8(0x00F8),	//	LATIN SMALL LETTER O WITH STROKE
"\xB9" => code_to_utf8(0x00B9),	//	SUPERSCRIPT ONE
"\xBA" => code_to_utf8(0x0157),	//	LATIN SMALL LETTER R WITH CEDILLA
...
"\xBF" => code_to_utf8(0x00E6),	//	LATIN SMALL LETTER AE
"\xC0" => code_to_utf8(0x0104),	//	LATIN CAPITAL LETTER A WITH OGONEK
"\xC1" => code_to_utf8(0x012E),	//	LATIN CAPITAL LETTER I WITH OGONEK
"\xC2" => code_to_utf8(0x0100),	//	LATIN CAPITAL LETTER A WITH MACRON
"\xC3" => code_to_utf8(0x0106),	//	LATIN CAPITAL LETTER C WITH ACUTE
...
"\xC6" => code_to_utf8(0x0118),	//	LATIN CAPITAL LETTER E WITH OGONEK
"\xC7" => code_to_utf8(0x0112),	//	LATIN CAPITAL LETTER E WITH MACRON
"\xC8" => code_to_utf8(0x010C),	//	LATIN CAPITAL LETTER C WITH CARON
"\xC9" => code_to_utf8(0x00C9),	//	LATIN CAPITAL LETTER E WITH ACUTE
"\xCA" => code_to_utf8(0x0179),	//	LATIN CAPITAL LETTER Z WITH ACUTE
"\xCB" => code_to_utf8(0x0116),	//	LATIN CAPITAL LETTER E WITH DOT ABOVE
"\xCC" => code_to_utf8(0x0122),	//	LATIN CAPITAL LETTER G WITH CEDILLA
"\xCD" => code_to_utf8(0x0136),	//	LATIN CAPITAL LETTER K WITH CEDILLA
"\xCE" => code_to_utf8(0x012A),	//	LATIN CAPITAL LETTER I WITH MACRON
"\xCF" => code_to_utf8(0x013B),	//	LATIN CAPITAL LETTER L WITH CEDILLA
"\xD0" => code_to_utf8(0x0160),	//	LATIN CAPITAL LETTER S WITH CARON
"\xD1" => code_to_utf8(0x0143),	//	LATIN CAPITAL LETTER N WITH ACUTE
"\xD2" => code_to_utf8(0x0145),	//	LATIN CAPITAL LETTER N WITH CEDILLA
"\xD3" => code_to_utf8(0x00D3),	//	LATIN CAPITAL LETTER O WITH ACUTE
"\xD4" => code_to_utf8(0x014C),	//	LATIN CAPITAL LETTER O WITH MACRON
...
"\xD8" => code_to_utf8(0x0172),	//	LATIN CAPITAL LETTER U WITH OGONEK
"\xD9" => code_to_utf8(0x0141),	//	LATIN CAPITAL LETTER L WITH STROKE
"\xDA" => code_to_utf8(0x015A),	//	LATIN CAPITAL LETTER S WITH ACUTE
"\xDB" => code_to_utf8(0x016A),	//	LATIN CAPITAL LETTER U WITH MACRON
"\xDC" => code_to_utf8(0x00DC),	//	LATIN CAPITAL LETTER U WITH DIAERESIS
"\xDD" => code_to_utf8(0x017B),	//	LATIN CAPITAL LETTER Z WITH DOT ABOVE
"\xDE" => code_to_utf8(0x017D),	//	LATIN CAPITAL LETTER Z WITH CARON
"\xDF" => code_to_utf8(0x00DF),	//	LATIN SMALL LETTER SHARP S (German)
"\xE0" => code_to_utf8(0x0105),	//	LATIN SMALL LETTER A WITH OGONEK
"\xE1" => code_to_utf8(0x012F),	//	LATIN SMALL LETTER I WITH OGONEK
"\xE2" => code_to_utf8(0x0101),	//	LATIN SMALL LETTER A WITH MACRON
"\xE3" => code_to_utf8(0x0107),	//	LATIN SMALL LETTER C WITH ACUTE
"\xE4" => code_to_utf8(0x00E4),	//	LATIN SMALL LETTER A WITH DIAERESIS
"\xE5" => code_to_utf8(0x00E5),	//	LATIN SMALL LETTER A WITH RING ABOVE
"\xE6" => code_to_utf8(0x0119),	//	LATIN SMALL LETTER E WITH OGONEK
"\xE7" => code_to_utf8(0x0113),	//	LATIN SMALL LETTER E WITH MACRON
"\xE8" => code_to_utf8(0x010D),	//	LATIN SMALL LETTER C WITH CARON
"\xE9" => code_to_utf8(0x00E9),	//	LATIN SMALL LETTER E WITH ACUTE
"\xEA" => code_to_utf8(0x017A),	//	LATIN SMALL LETTER Z WITH ACUTE
"\xEB" => code_to_utf8(0x0117),	//	LATIN SMALL LETTER E WITH DOT ABOVE
"\xEC" => code_to_utf8(0x0123),	//	LATIN SMALL LETTER G WITH CEDILLA
"\xED" => code_to_utf8(0x0137),	//	LATIN SMALL LETTER K WITH CEDILLA
"\xEE" => code_to_utf8(0x012B),	//	LATIN SMALL LETTER I WITH MACRON
"\xEF" => code_to_utf8(0x013C),	//	LATIN SMALL LETTER L WITH CEDILLA
"\xF0" => code_to_utf8(0x0161),	//	LATIN SMALL LETTER S WITH CARON
"\xF1" => code_to_utf8(0x0144),	//	LATIN SMALL LETTER N WITH ACUTE
"\xF2" => code_to_utf8(0x0146),	//	LATIN SMALL LETTER N WITH CEDILLA
"\xF3" => code_to_utf8(0x00F3),	//	LATIN SMALL LETTER O WITH ACUTE
"\xF4" => code_to_utf8(0x014D),	//	LATIN SMALL LETTER O WITH MACRON
...
"\xF8" => code_to_utf8(0x0173),	//	LATIN SMALL LETTER U WITH OGONEK
"\xF9" => code_to_utf8(0x0142),	//	LATIN SMALL LETTER L WITH STROKE
"\xFA" => code_to_utf8(0x015B),	//	LATIN SMALL LETTER S WITH ACUTE
"\xFB" => code_to_utf8(0x016B),	//	LATIN SMALL LETTER U WITH MACRON
"\xFC" => code_to_utf8(0x00FC),	//	LATIN SMALL LETTER U WITH DIAERESIS
"\xFD" => code_to_utf8(0x017C),	//	LATIN SMALL LETTER Z WITH DOT ABOVE
