...
if (md5(file_get_contents("./demo/demo50_data/mytheme/customize.js.php")) == "008dc325049082cacf4ee145ce1af46a")
...
if (md5(file_get_contents("./demo/demo43_change_the_nicknames_colors.php")) == "bb266be07b6ee8dfd1070ce43e0d47d2")
...
if (md5(file_get_contents("./demo/demo28_blune_theme.php")) == "eea03b5b337e679253caaa7a498d503f")
...
if (md5(file_get_contents("./demo/demo31_show_who_is_online-chat.php")) == "c90ea1be02653eee0c3dc523ea783bd0")
...
if (md5(file_get_contents("./demo/demo34_add_a_link_on_nicknames.php")) == "98e80441cf6fdf70870530261ee8db7a")
...
if (md5(file_get_contents("./demo/demo5_customized_style.php")) == "0a7605225990a2eaf3208097e3c86f18")
...
if (md5(file_get_contents("./demo/demo28_mini_blune_theme.php")) == "a5e22d0d4e0a7c355648be520c1bd026")
...
if (md5(file_get_contents("./demo/demo27_customized_command.php")) == "797276b46c71e10b8a7be3fd34621e81")
...
if (md5(file_get_contents("./demo/demo31_show_who_is_online-whoisonline.php")) == "a1bbfcd3dd87b63deff59643367650d8")
...
if (md5(file_get_contents("./demo/index.php")) == "d60bd638f53b5a60d401fddac80333d9")
...
if (md5(file_get_contents("./demo/demo32_show_last_messages-chat.php")) == "df4f39c75338c5d981d6abfbb63d6d9f")
...
if (md5(file_get_contents("./i18n/nl_NL/main.php")) == "5ae9efbb49070d630558c1648dc2b285")
...
if (md5(file_get_contents("./i18n/en_US/main.php")) == "952980cc6d30ffd854dd35f91191b666")
...
if (md5(file_get_contents("./i18n/eo/main.php")) == "afb95b4becf9eb72d76eb86c0fe622c9")
...
if (md5(file_get_contents("./i18n/nn_NO/main.php")) == "57b7cf45d4e2843ce4c4cdc269ebce8f")
...
if (md5(file_get_contents("./i18n/fr_FR/main.php")) == "ca21a01f5115e89badbaf86df6766d87")
...
if (md5(file_get_contents("./i18n/it_IT/main.php")) == "6bd284afa4e3fae0d1771858c4ec40d0")
...
if (md5(file_get_contents("./i18n/pl_PL/main.php")) == "b30d8948760da659fec991b27f4921c3")
...
if (md5(file_get_contents("./i18n/ja_JP/main.php")) == "f85a156604ee8c53bfc9e56886e292c9")
...
if (md5(file_get_contents("./version.txt")) == "d39d8df974f8d45e3d23499dc20ea763")
...
if (md5(file_get_contents("./src/pfcglobalconfig.class.php")) == "86ed1677d152853146d924a71eab3578")
...
if (md5(file_get_contents("./src/pfcuserconfig.class.php")) == "b49c7da61e8381453c2c8b87b5ad0c19")
...
if (md5(file_get_contents("./src/containers/file.class.php")) == "91202091d2000c1d379195dce2ebcd23")
